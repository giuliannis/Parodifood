...
describe('Realizar um pedido com pagamento por cartão refeição', () => {
    ...
    it('E a opção de pagamento por cartão refeição foi marcada', () => {
        Pagamento.selecionarPagamentoPorRefeicao();
    });
